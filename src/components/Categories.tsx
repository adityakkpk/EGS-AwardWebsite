      ...
      submenus: [
        {
          ...
          description: "Demonstrates measurable impact on industry through innovation.",
        ...
        },
        {
          ...
          description: "Sustained success in multi-generational business leadership.",
          image: "/awards-ceremony.webp"
        },
        {
          id: 6,
          name: "Best Emerging Business",
          description: "Rapid growth and market disruption with measurable success.",
          image: "/awards-ceremony.webp"
        },
        {
          id: 7,
        ...
        },
        {
          ...
          description: "High customer retention, satisfaction, and service innovation.",
          image: "/awards-ceremony.webp"
        },
        {
          id: 9,
          name: "Best Business Expansion Strategy",
          description: "Successful expansion strategies backed by data-driven insights.",
          image: "/awards-ceremony.webp"
        },
        {
          id: 10,
      ...
      submenus: [
        {
          ...
          description: "Documented breakthroughs in research leading to market adoption.",
          image: "/awards-ceremony.webp"
        },
        {
          id: 12,
        ...
        },
        {
          ...
          description: "Proven AI/digital innovation impacting business operations.",
          image: "/awards-ceremony.webp"
        },
        {
          id: 14,
        ...
        },
        {
          ...
          description: "Urban transformation through technology and smart solutions.",
          image: "/awards-ceremony.webp"
        },
        {
          id: 16,
        ...
        },
        {
          ...
          description: "Security solutions that improve business trust and transparency.",
          image: "/awards-ceremony.webp"
        },
        {
          id: 19,
          name: "Smart Manufacturing Excellence Award",
          description: "Advanced manufacturing techniques with industry-wide influence.",
          image: "/awards-ceremony.webp"
        },
        {
          id: 20,
    ...
    },
    {
      ...
      submenus: [
        ...
        },
        {
          ...
          description: "Business ethics compliance and best practices implementation.",
          image: "/awards-ceremony.webp"
        },
        {
          id: 26,
          name: "Women in Business Leadership Award",
          description: "Women-led initiatives demonstrating measurable success.",
          image: "/awards-ceremony.webp"
        },
        {
          id: 27,
          name: "Excellence in Inclusive Business Practices",
          description: "Inclusive business practices fostering workplace diversity.",
          image: "/awards-ceremony.webp"
        },
        {
          id: 28,
          name: "Excellence in Circular Economy Innovations",
          description: "Sustainable models integrating circular economy principles.",
          image: "/awards-ceremony.webp"
        },
        {
          id: 29,
      ...
      submenus: [
        {
          ...
          description: "Cross-border collaborations generating economic impact.",
          image: "/awards-ceremony.webp"
        },
        {
          id: 32,
          name: "Excellence in Bilateral Trade Relations",
          description: "Trade relationships fostering bilateral business growth.",
          image: "/awards-ceremony.webp"
        },
        {
          id: 33,
          name: "Cultural Diplomacy & Exchange Excellence",
          description: "Successful cultural exchange initiatives backed by results.",
          image: "/awards-ceremony.webp"
        },
        {
          id: 34,
        ...
        },
        {
          ...
          description: "Food and hospitality ventures enhancing cultural connections.",
          image: "/awards-ceremony.webp"
        },
        {
          id: 37,
          name: "Heritage & Art Business Excellence",
          description: "Heritage conservation projects with sustainable revenue models.",
          image: "/awards-ceremony.webp"
        },
        {
          id: 38,
          name: "Best Educational Collaboration between India & Oman",
          description: "Educational partnerships boosting bilateral student exchanges.",
          image: "/awards-ceremony.webp"
        },
        {
          id: 39,
          name: "Excellence in Infrastructure Development",
          description: "Infrastructure collaborations fostering long-term growth.",
          image: "/awards-ceremony.webp"
        },
        {
          id: 40,
          name: "Excellence in Health & Well-Being Collaboration",
          description: "Healthcare initiatives or wellness programs showing measurable impact.",
          image: "/awards-ceremony.webp"
        }
      ]
    },
    {
      ...
      submenus: [
        ...
        },
        {
          ...
          description: "Real estate and construction projects with lasting impact.",
          image: "/awards-ceremony.webp"
        },
        {
          id: 45,
    ...
    <section id="categories" className="pt-10 max-w-screen-xl mx-auto">
      ...
      <div className="flex flex-col lg:flex-row gap-4 lg:gap-8">
            ...
            <div key={category.id} className="mb-2">
              <button
                className={`text-left p-3 sm:p-4 font-semibold text-base sm:text-lg 
                  ...
                  border flex gap-5 items-center
              ...
              >
                <div className="border-x border-b rounded-b-lg pl-10">
                  {category.submenus.map((item) => (
                    <button
                      key={item.id}
                      className={`w-full text-left py-2 px-4 text-sm sm:text-base
                        hover:bg-red-50 border-b last:border-b-0 transition-colors duration-200 rounded
                        ${
        ...
        <div className="w-full lg:w-1/2">
          ...
          >
            {selectedItem && (
              <div className="border rounded-lg shadow-md lg:sticky lg:top-8">
