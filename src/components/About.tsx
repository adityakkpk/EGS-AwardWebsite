      ...
      <div className="max-w-screen-xl mx-auto px-4 py-12">
        ...
        <div className="space-y-6 px-4 sm:px-10">
          ...
          >
            ...
            prestigious global event dedicated to recognizing and celebrating
            outstanding achievements in business, research, and innovation. This
            event honors industrialists, researchers, and innovators who have
            demonstrated excellence in their respective fields, contributing
            significantly to their industries and society.
          </p>
          ...
          >
            ...
            countries worldwide. The event serves as a platform to acknowledge
            exceptional contributions and inspire future leaders in various
            industries.
          </p>
        </div>
